		...
		return $elm$url$Url$Parser$getFirstMatch(
			parser(
				A5(
					...
					$elm$url$Url$Parser$prepareQuery(url._),
					url.P,
					$elm$core$Basics$identity)));
	});
var $author$project$Model$IndexPage = 0;
var $author$project$Model$LoginPage = 1;
...
var $author$project$Main$view = function (model) {
	var _v0 = function () {
		var _v1 = A2($elm$url$Url$Parser$parse, $author$project$Model$routeParser, model.af);
		if (!_v1.$) {
			if (!_v1.a) {
				var _v2 = _v1.a;
...
var $author$project$Main$main = $elm$browser$Browser$application(
	{at: $author$project$Main$init, aw: $author$project$Main$UrlChanged, ax: $author$project$Main$UrlRequested, aA: $author$project$Main$subscriptions, aC: $author$project$Main$update, aD: $author$project$Main$view});
